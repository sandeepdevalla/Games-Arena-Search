...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppComponent.ɵfac = function AppComponent_Factory(t) {
      return new (t || AppComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_app_service__WEBPACK_IMPORTED_MODULE_1__["default"]));
    };
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AppComponent, [{
        ...
        return [{
          type: _app_service__WEBPACK_IMPORTED_MODULE_1__["default"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _score_board_score_board_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./score-board/score-board.component */
    "./src/app/score-board/score-board.component.ts");
    /* harmony import */


    var _score_card_score_card_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./score-card/score-card.component */
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_3__["ScrollingModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_6__["DashboardComponent"], _search_search_component__WEBPACK_IMPORTED_MODULE_7__["SearchComponent"], _score_board_score_board_component__WEBPACK_IMPORTED_MODULE_8__["ScoreBoardComponent"], _score_card_score_card_component__WEBPACK_IMPORTED_MODULE_9__["ScoreCardComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_3__["ScrollingModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppAppServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _assets_games_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../assets/games.json */
    "./src/assets/games.json");

    var _assets_games_json__WEBPACK_IMPORTED_MODULE_3___namespace = /*#__PURE__*/__webpack_require__.t(
    /*! ../assets/games.json */
    "./src/assets/games.json", 1);
    /* harmony import */
    ...
    var AppService = /*#__PURE__*/function () {
      ...
      _createClass(AppService, [{
        key: "getDataFromStarlord",
        value: function getDataFromStarlord() {
          var url = 'https://starlord.hackerearth.com/gamesarena';
          return this.http.get(url);
        }
      }, {
        key: "storeUsingTransaction",
        value: function storeUsingTransaction(db, data) {
          var _this = this;
          ...
          res.onsuccess = function (data) {
            _this.gamesDataSubscriber$.next(data.target.result);
          };
        }
      }, {
        key: "storeGameDataInDb",
        value: function storeGameDataInDb(db) {
          var _this2 = this;

          this.getDataFromStarlord().subscribe(function (data) {
            _this2.storeUsingTransaction(db, data.splice(1));
          }, function (error) {
            console.log('inside error', error);

            _this2.storeUsingTransaction(db, _assets_games_json__WEBPACK_IMPORTED_MODULE_3__);
          });
        }
      }, {
        key: "connectIndexedDb",
        value: function connectIndexedDb() {
          var _this3 = this;

          this.dbInstance = window.indexedDB.open("GamesScoreData");

          this.dbInstance.onupgradeneeded = function (event) {
          ...
          this.dbInstance.onsuccess = function (event) {
            var db = event.target['result'];
            var res = db.transaction("scores", "readwrite").objectStore("scores").getAll();

            res.onsuccess = function (data) {
              _this3.gamesDataSubscriber$.next(data.target.result);
            };
          };
        }
      }, {
        key: "getFilterData",
        value: function getFilterData(title) {
          var _this4 = this;
          ...
          this.dbInstance.onsuccess = function (event) {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this4, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
              ...
              var db, scoresObjectStore, index, res;
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      db = event.target['result'];
                      scoresObjectStore = db.transaction("scores", "readwrite").objectStore("scores");
                      index = scoresObjectStore.index('title');
                      ...
                      res.onsuccess = function (data) {
                        ...
                        _this5.gamesDataSubscriber$.next(title ? [data.target.result] : data.target.result);
                      };
    ...
    AppService.ɵfac = function AppService_Factory(t) {
      return new (t || AppService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"]));
    };
  ...
  function srcAppDashboardDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DashboardComponent = /*#__PURE__*/function () {
      ...
      _createClass(DashboardComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.appService.gamesDataSubscriber$.subscribe(function (data) {
            _this6.gamesData = data;
          });
        }
      }, {
        key: "searchTitle",
        value: function searchTitle(value) {
    ...
    DashboardComponent.ɵfac = function DashboardComponent_Factory(t) {
      return new (t || DashboardComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_app_service__WEBPACK_IMPORTED_MODULE_1__["default"]));
    };
  ...
  function srcAppScoreBoardScoreBoardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _score_card_score_card_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../score-card/score-card.component */
    "./src/app/score-card/score-card.component.ts");

    function ScoreBoardComponent_ng_container_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ScoreBoardComponent_div_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    ScoreBoardComponent.ɵfac = function ScoreBoardComponent_Factory(t) {
      return new (t || ScoreBoardComponent)();
    };
    ...
    ScoreBoardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      inputs: {
        gamesArenaScores: "gamesArenaScores"
      },
      features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵNgOnChangesFeature"]],
      decls: 4,
      vars: 4,
      consts: [[1, "score-board-panel"], ["itemSize", "200", "minBufferPx", "50", "maxBufferPx", "50"], [4, "cdkVirtualFor", "cdkVirtualForOf"], ["class", "no-data", 4, "ngIf"], [1, "score-card-layout", 3, "gameData"], [1, "no-data"], [1, "loading-layout"], [1, "bounce-ball"]],
  ...
  /***/
  function srcAppScoreCardScoreCardComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function ScoreCardComponent_img_8_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "img", 6);
      }
    }

    var ScoreCardComponent = /*#__PURE__*/function () {
    ...
    ScoreCardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      selectors: [["app-score-card"]],
      inputs: {
        gameData: "gameData"
      },
      decls: 14,
      vars: 5,
      consts: [[1, "score-card"], [1, "image-div"], ["src", "assets/avtar.jpeg", "alt", "", 1, "image-frame"], [1, "title-div"], ["style", "float: right;", "src", "assets/editor-choice.png", 4, "ngIf"], [1, "score-div"], ["src", "assets/editor-choice.png", 2, "float", "right"]],
  ...
  function srcAppSearchSearchComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function SearchComponent_option_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var SearchComponent = /*#__PURE__*/function () {
      ...
      _createClass(SearchComponent, [{
        ...
        key: "getRefreshList",
        value: function getRefreshList(event) {
        ...
        key: "searchGames",
        value: function searchGames(event) {
          this.searchTitle.emit(event.target.value);
        }
      }]);
    ...
    SearchComponent.ɵfac = function SearchComponent_Factory(t) {
      return new (t || SearchComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_app_service__WEBPACK_IMPORTED_MODULE_1__["default"]));
    };
    ...
    SearchComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 3,
      vars: 1,
      consts: [["type", "search", "list", "gamesList", "placeholder", "Search by (Title)", 1, "game-search", 3, "input", "change"], ["id", "gamesList"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"]],
      template: function SearchComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("input", function SearchComponent_Template_input_input_0_listener($event) {
            return ctx.getRefreshList($event);
          })("change", function SearchComponent_Template_input_change_0_listener($event) {
            return ctx.searchGames($event);
          });
  ...
  /***/
  function srcAssetsGamesJson(module) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\sdevalla\Games-Arena-Search\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
